# mtcnn detector: (https://github.com/kpzhang93/MTCNN_face_detection_alignment)
# coding: utf-8
import os
import mxnet as mx
import numpy as np
...
from lib.helper import nms, adjust_input, detect_first_stage_warpper

DETECTOR_PATH = os.path.dirname(os.path.abspath(__file__))
...
class MtcnnDetector(object):
    ...
    def __init__(self,
                 model_folder=os.path.join(DETECTOR_PATH, '../PretrainedModels/mtcnn-model'),
                 minsize=20,
    ...
    def list2colmatrix(self, pts_list):
        ...
        colMat = np.array(colMat).transpose()
        return colMat
    ...
    def extract_image_chips(self, img, points, desired_size=256, padding=0):
        ...
        for p in points:
            ...
            probe_vec = np.array([1.0, 0.0]).transpose()
