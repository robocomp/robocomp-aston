...
class opts(object):
  def __init__(self):
    ...
    self.parser.add_argument('iceconfigfile', nargs='*', type=str, default=['etc/config','etc/confinew'])
    self.parser.add_argument('--startup-check', action='store_true')
    ...
    self.parser.add_argument('--demo', default='', 
                             help='path to image/ image folders/ video. '
                                  'or "webcam"')
    self.parser.add_argument('--load_model', default='./src/PretrainedModels/coco_tracking.pth',
